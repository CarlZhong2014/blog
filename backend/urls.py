...
urlpatterns = [
    url(r'^article/list', backend.views.list_article, name='backend_list_article'),
    ...
    url(r'^category/delete', backend.views.delete_category, name='backend_delete_category'),
]